...
Size descriptions can be found [here](https://www.cannondale.com/en-it/bikes/mountain/trail-bikes/jekyll/jekyll-carbon-29-2?sku=c21200m10sm) under the *What's my size?* section.     
...
* Before using the Jekyll, riders need to make sure their front and rear suspension have the proper PSI (pounds per square inch) for their weight. 
 ...
 * When suspension is set up properly the rider should adjust seat height.  
    ...
    * c) Place a foot on a pedal and fully extend that leg.  
    * d) Pull the seat post up far enough to sit comfortably.  
...
### Sponsored Riders
<img src="MitchRopelato.jpg" width="500" height="750" alt="Back to Top">
